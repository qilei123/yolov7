...
python evaluation.py --weights out/WJ_V1_with_mfp7-22-2_retrain/yolov7-wj_v1_with_fp/weights/best.pt --data data/wj_v1_with_fp.yaml --batch-size 32 --device 3 --exist-ok --verbose --save-txt --save-conf --iou-thres 0.0 --conf-thres 0.3